...
public class PicassoTestUtils {
    ...
    static final String STABLE_URI_KEY_1 = createKey(
            new Request.Builder(URI_1).stableKey(STABLE_1).build());
    ...
    static final Uri MEDIA_STORE_CONTENT_1_URL = Uri
    ...
    static final String RESOURCE_ID_URI_KEY = createKey(
    ...
    public static Picasso mockPicasso() {
